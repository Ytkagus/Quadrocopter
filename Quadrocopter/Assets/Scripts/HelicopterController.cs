...
public class HelicopterController : MonoBehaviour
{
    ...
    public HeliRotorController MainRotorController2;
    public HeliRotorController SubRotorController;
    public HeliRotorController SubRotorController2;
    ...
    public float EngineForce
    {
        ...
        set
        {
            MainRotorController.RotarSpeed = value * 8000;
            MainRotorController2.RotarSpeed = value * 8000;
            SubRotorController.RotarSpeed = value * 4000;
            SubRotorController2.RotarSpeed = value * 4000;
